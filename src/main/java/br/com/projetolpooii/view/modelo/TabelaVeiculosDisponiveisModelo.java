...
public class TabelaVeiculosDisponiveisModelo extends AbstractTableModel {

    private final List<Veiculo> veiculos = new ArrayList<>();
    private final String[] colunas = {"Placa", "Marca", "Modelo", "Ano", "Categoria", "Valor diária"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        return switch (columnIndex) {
            ...
            case 4 -> veiculo.getCategoria().name();
            case 5 -> FormatadorMonetario.formatar(veiculo.getValorDiariaLocacao());
            default -> "";
        };
    }
